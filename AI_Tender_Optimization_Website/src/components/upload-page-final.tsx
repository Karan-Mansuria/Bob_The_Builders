...
export function UploadPageFinal({ userEmail, onNavigateToDashboard, onLogout }: UploadPageFinalProps) {
  ...
  const startAnalysis = (assumptions: { miscellaneous: number; labour: number; wastage: number; quality: number }) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        // Auto-scroll to results with animation
        setTimeout(() => {
  ...
  const mockResults = {
    ...
    confidence: 87,
    recommendations: [
      "Material costs optimized based on quality level",
      "Labour allocation suggests 8% efficiency gain",
      "Wastage reduction opportunities identified",
    ],
  };
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    >
                      ...
                      <div className="text-3xl text-primary">{mockResults.totalCost}</div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="text-3xl text-accent-positive">{mockResults.profitMargin}</div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="text-3xl text-primary">{mockResults.winProbability}</div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="text-3xl text-accent-yellow">{mockResults.timeline}</div>
                    </motion.div>
